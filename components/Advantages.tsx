  ...
  return (
    <div className="max-w-[1700px] mx-auto px-6 md:px-12 relative">
      ...
      <div className="absolute top-0 right-0 p-12 opacity-10 hidden lg:block select-none pointer-events-none">
        <div className="font-mono text-[10px] space-y-2 uppercase tracking-widest text-[#18215A] dark:text-[#ACcFFF] transition-colors">
      ...
      <div className="mb-24 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
        <div className="max-w-4xl">
          <div className="flex items-center gap-4 text-[#72A1E1] mb-6">
          ...
          <h2 className="font-display text-7xl lg:text-[10rem] font-bold text-[#00083C] dark:text-white uppercase tracking-tighter leading-[0.85] transition-colors">
            ЦИФРОВАЯ <br />
              ЭКОСИСТЕМА
          </h2>
        </div>

        <div className="max-w-sm border-l-2 border-[#72A1E1]/40 pl-8">
          <p className="text-slate-600 dark:text-[#ACcFFF]/75 text-xl font-light italic leading-relaxed transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[350px]">
        ...
        <div className="md:col-span-8 md:row-span-2 group relative overflow-hidden p-12 lg:p-20 flex flex-col justify-end shadow-2xl transition-all duration-500
          ...
          {/* soft glow */}
          <div className="absolute -top-40 -right-40 h-[520px] w-[520px] rounded-full bg-[#72A1E1]/25 blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
        ...
        <div className="md:col-span-4 rounded-xl p-12 flex flex-col justify-between transition-all duration-500 group shadow-xl
          ...
          <div className="flex justify-between items-start">
            <TrendingUp size={32} className="text-[#72A1E1]" />
            <span className="text-[9px] font-mono text-slate-400 dark:text-[#ACcFFF]/55">
              REALTIME_METRIC
            </span>
          </div>

          <div>
            <div className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-500 dark:text-[#ACcFFF]/60 mb-2">
              Надежность
            </div>
            <div className="font-display text-7xl font-bold text-[#00083C] dark:text-white tracking-tighter transition-colors">
              98.5%
            </div>
          </div>

          <div className="w-full h-1 overflow-hidden rounded-full bg-[#18215A]/10 dark:bg-white/10">
            <div className="h-full bg-[#72A1E1] w-0 group-hover:w-[98.5%] transition-all duration-1000"></div>
          </div>
        </div>
        ...
        <div className="md:col-span-4 rounded-xl p-12 flex flex-col justify-between shadow-xl transition-all duration-500 group
          ...
          <div>
            <div className="font-display text-7xl font-bold text-[#00083C] dark:text-white group-hover:text-[#00083C] dark:group-hover:text-white tracking-tighter transition-colors">
              500+
            </div>
            <div className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-500 dark:text-[#ACcFFF]/70 group-hover:text-[#ACcFFF] mt-2 transition-colors">
              Активных партнеров
            </div>
          </div>

          <div className="mt-6 h-[2px] w-0 bg-[#72A1E1] group-hover:w-full transition-all duration-700"></div>
        </div>
        ...
        <div className="md:col-span-12 rounded-xl p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 transition-all duration-500 group shadow-xl
          ...
          <div className="flex items-center gap-10">
            ...
            <div>
              <h4 className="font-display text-4xl font-bold text-[#00083C] dark:text-white uppercase tracking-tighter mb-2 transition-colors">
                ВИЗУАЛЬНЫЙ МОНИТОРИНГ
              </h4>
              <p className="font-light italic uppercase text-xs tracking-widest transition-colors
                            text-slate-500 dark:text-[#ACcFFF]/70">
            ...
            {[...Array(4)].map((_, i) => (
              <div
                ...
                className="w-1.5 h-16 rounded-full overflow-hidden relative
                           bg-[#18215A]/10 dark:bg-white/10"
              >
                <div
                  className="absolute bottom-0 left-0 w-full bg-[#72A1E1] transition-all duration-1000"
