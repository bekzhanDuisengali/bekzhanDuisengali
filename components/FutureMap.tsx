...
const FutureMap: React.FC = () => {
  return (
    <div className="relative flex h-full items-center overflow-hidden bg-[#020512] py-20 text-white sm:py-24 lg:py-28">
      ...
      <div className="relative mx-auto flex max-w-[1280px] flex-col gap-12 px-6 lg:px-8">
        <div className="mx-auto max-w-[1240px] text-center">
          <h2 className="font-display text-[2.4rem] font-semibold leading-[0.98] tracking-[-0.05em] text-white/92 sm:text-[3.4rem] lg:text-[95px]">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.78fr)] lg:gap-11">
          ...
          <div className="mx-auto flex max-w-[620px] flex-col justify-center pt-1 lg:mx-0 lg:pt-3">
            <h3 className="font-display m-0 text-[1.6rem] font-semibold leading-[1.08] tracking-[-0.04em] text-white/90 sm:text-[2.2rem] lg:text-[50px]">
            ...
            <p className="m-0 text-[1.02rem] font-light leading-[1.6] tracking-[-0.02em] text-white/70 sm:text-[1.1rem] lg:text-[25px]">
